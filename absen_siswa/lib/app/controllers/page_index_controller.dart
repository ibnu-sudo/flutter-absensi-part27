    ...
    switch (i) {
      case 1:
        ...
        if (dataResponse["error"] != true) {
          ...
          await updatePostion(position, address);
          //cek distance between 2 position
          //mengatur lokasi jarak jangkauan absen
          double distance = Geolocator.distanceBetween(
              -6.1932084, 106.5684342, position.latitude, position.longitude);
    ...
    if (snapPresence.docs.length == 0) {
      ...
      if (todayDoc.exists == true) {
        ...
        if (dataPresenceToday?["keluar"] != null) {
          ...
          Get.snackbar("Succes", "Kamu telah absen masuk & keluar");
        } else {
          //absen keluar
